...
"""
I do not see the need why an organizer should be able to see ticket instances, since they alredy see the bookings they have made.
I also do not see the need to see the ticket instances for a specific event, since the organizer can see the bookings for that event.
"""
