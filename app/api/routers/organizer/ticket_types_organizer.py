...
@router.post("/organizers/events/{event_id}/ticket-types", response_model=TicketTypeOut)
async def create_ticket_type(event_id: int, ticket_type_in: TicketTypeCreate, organizer=Depends(require_organizer)):
    ...
    return tt_services.create_ticket_type_service(event_id, ticket_type_in)

@router.put("/organizers/ticket-types/{ticket_type_id}", response_model=TicketTypeOut)
...
@router.delete("/organizers/ticket-types/{ticket_type_id}", response_model=dict)
...
@router.get("/organizers/events/{event_id}/ticket-types", response_model=list[TicketTypeOut])
...
@router.get("/organizers/ticket-types/{ticket_type_id}", response_model=TicketTypeOut)
