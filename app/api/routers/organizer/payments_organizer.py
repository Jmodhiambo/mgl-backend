...
def list_all_payments(user=Depends(require_organizer)):
...
def list_payments_by_status(status: str, user=Depends(require_organizer)):
...
def list_latest_payments(latest: int = 10, user=Depends(require_organizer)):
