    ...
    def __init__(self):
        super().__init__(
            ...
            required_variables=[
                ...
                'booking_id', 'old_venue', 'new_venue', 'venue_address',
                        ...
                        <td style="padding: 40px;">
                            ...
                            <div style="background-color: #fef3c7; border-left: 4px solid #f59e0b; padding: 25px; border-radius: 4px; margin: 30px 0;">
                                ...
                                <table style="width: 100%; border-collapse: collapse;">
                                    ...
                                    <tr>
                                        <td style="padding: 8px 0; color: #78350f; font-size: 14px;">Address:</td>
                                        <td style="padding: 8px 0; color: #78350f; font-size: 14px;">{venue_address}</td>
                                    </tr>
                                </table>
                            </div>
